...
const ContainerOnly = ({ attributes, setAttributes }) => {
    ...
    return (React.createElement(SelectControl, { label: React.createElement(React.Fragment, null,
            "Container size",
            React.createElement(FieldTooltip, { tooltip: 'Represents the maximum width of the content area inside the block; may appear to have no effect on smaller viewports' })), size: '__unstable-large', value: attributes.size, options: options, onChange: (newSize) => setAttributes({ size: newSize }) }));
};
