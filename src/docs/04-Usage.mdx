...
The below is an overview of how this package is implemented in the Comet Components plugin for the WordPress block editor. This could be adapted for other use cases.
